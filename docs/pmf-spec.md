...
SIYUAN_ENABLE_WRITE=true node index.js append-block "docID" "新段落内容"
...
# 2. 替换标题下的所有内容
SIYUAN_ENABLE_WRITE=true node index.js replace-section "标题块ID" "新的段落内容"
```
...
# 3. 逐步追加新内容
SIYUAN_ENABLE_WRITE=true node index.js append-block "docID" "## 概览"
SIYUAN_ENABLE_WRITE=true node index.js append-block "docID" "|列1|列2|
|---|---|
|数据|数据|"
